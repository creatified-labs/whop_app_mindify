...
export const PROGRAMS_LIBRARY: Program[] = [
	{
		...
		recommendedFor: ["Founders", "Operators", "Creators with scattered focus"],
	...
	},
	{
		...
		recommendedFor: ["Founders scaling teams", "Agency owners", "Creators launching products"],
	...
	},
	{
		...
		recommendedFor: ["Founders with late-night rumination", "Shifted sleep schedules", "Parents needing evening calm"],
	...
	},
	{
		...
		recommendedFor: ["Leaders stepping into new roles", "Creators scaling personal brand", "Anyone rewiring self-talk"],
	...
	},
	{
		...
		recommendedFor: ["High-output leaders", "Folks rebuilding routines", "Anyone post-burnout"],
