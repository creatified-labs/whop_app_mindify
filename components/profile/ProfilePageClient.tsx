...
import { Bell, CreditCard, LogOut, Mail, Shield } from "lucide-react";
...
export function ProfilePageClient({ userData, stats }: ProfilePageClientProps) {
					...
					<div className="flex flex-wrap items-start justify-between gap-6">
						<div className="flex items-center gap-4">
							...
							<div>
								...
								{userData.email && (
									<p className="mt-1 text-sm text-earth-600 dark:text-[#CFC7BB]">{userData.email}</p>
								)}
							</div>
						</div>
						...
						<div className="rounded-3xl border border-sage-100 bg-cream-50 p-6 dark:border-white/10 dark:bg-[#13151A]">
							<div className="flex items-start gap-4">
								...
								<div className="flex-1">
									...
									<p className="mt-1 text-sm text-earth-600 dark:text-[#CFC7BB]">
										{userData.membershipTier} - Active
									</p>
